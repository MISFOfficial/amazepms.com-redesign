...
export const JobOpeningCard: React.FC<JobOpeningCardProps> = ({
  ...
  return (
    <div className="job-opening-card group bg-[var(--white)] primary-rounded p-5 sm:p-6 border border-[var(--primary)]/20  hover:border-[var(--secondary)] hover: transition-all duration-500 flex flex-col justify-between h-full text-[var(--black)]">
      <div>
      ...
      <div className="pt-4 mt-4 border-t border-[var(--primary)]/15 flex items-center justify-between">
        ...
        <button
          onClick={onApply}
          className="inline-flex items-center gap-1.5 px-4 py-2 primary-rounded bg-[var(--primary)] hover:bg-[var(--secondary)] text-[var(--white)] text-xs font-bold transition-all duration-300  group-hover:scale-105"
        >
          <span>Apply</span>
