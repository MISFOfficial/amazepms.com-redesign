...
export const WhyHeader: React.FC = () => {
  return (
    <div className="text-center max-w-3xl mx-auto space-y-1.5 sm:space-y-2 mb-0 px-2">
      {/* Top Tagline Badge */}
      <div className="inline-flex items-center gap-1.5 px-3.5 py-1 bg-[var(--primary)]/10 border border-[var(--primary)]/20 text-[var(--primary)] text-[10px] sm:text-xs font-semibold rounded-full shadow-xs">
