...
export const WhyVisuals: React.FC = () => {
  ...
  return (
    <div className="relative w-full max-w-lg mx-auto lg:max-w-none py-4">
      ...
      <div className="relative w-full h-[360px] sm:h-[440px] primary-rounded overflow-hidden  border border-slate-200 bg-slate-900 group">
        <Image
        ...
        {/* Overlay Banner */}
        <div className="absolute bottom-4 left-4 right-4 p-4 bg-white/95 backdrop-blur-md primary-rounded border border-slate-200/80 ">
      ...
      <div
        ref={floatCardRef}
        className="absolute top-10 -right-2 sm:-right-6 w-[52%] sm:w-[48%] h-[200px] sm:h-[240px] primary-rounded overflow-hidden  border-4 border-white bg-slate-900 z-20 group"
      >
        <Image
