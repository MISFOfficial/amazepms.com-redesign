  ...
  return (
    <section className="relative w-full bg-[var(--white)] py-16 sm:py-20 lg:py-24 border-b border-[var(--primary)]/10 overflow-hidden text-center text-[var(--black)]">
      ...
      <div className="ratio relative z-10 flex flex-col items-center justify-center space-y-3">
        {/* Page Title */}
        <h1 className="text-3xl sm:text-5xl lg:text-6xl font-bold tracking-tight text-[var(--secondary)]">
          Recruitment Strategy
        </h1>
        <p className="text-xs sm:text-sm text-[var(--black)]/80 max-w-xl mx-auto font-sans leading-relaxed font-normal">
          Structured manpower sourcing across 8+ states and rigorous in-house
          antecedent background verification.
        </p>
      </div>
    </section>
  );
